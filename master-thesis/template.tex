...
%
%   The ucsd.cls class files are only valid for master thesis.
%
%
% ----------------------------------------------------------------------
% GETTING STARTED:
...
%
% fonts: 10pt, 11pt, 12pt -- are valid for UCSD thesis.
...
%    of these if writing a thesis that includes equations.
